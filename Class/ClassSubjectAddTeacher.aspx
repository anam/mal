<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site2Column.master"
    CodeFile="ClassSubjectAddTeacher.aspx.cs" Inherits="AdminDisplaySTD_ClassTeacher"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="content-box">
        ...
        <div class="inner-form">
                    ...
                    <asp:GridView ID="gvSubject" runat="server" AutoGenerateColumns="false" OnRowDataBound="gvSubject_RowDataBound">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Teacher">
                                <ItemTemplate>
                                    <asp:DropDownList ID="ddlTeacherID" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlTeacherID_SelectedIndexChanged" >
                                    </asp:DropDownList>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
            ...
            <div  style="width: 780px; height:500px; overflow: scroll;">
                <asp:Label ID="lblVerifyRoutine" runat="server" Text=""></asp:Label>
            </div>
        </div>
    </div>
    <div class="content-box">
