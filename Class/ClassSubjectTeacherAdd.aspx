<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site2Column.master"
    CodeFile="ClassSubjectTeacherAdd.aspx.cs" Inherits="AdminDisplaySTD_ClassSubjectTeacher" Title="STD_ClassSubject Insert/Update By Admin" %>
     ...
     <asp:TextBox ID="txtClassSubjectName" class="txt large-input" runat="server" Text="">
                ...
                <dd>
                   <%-- <asp:DropDownList ID="ddlSubjectID" runat="server">
                    ...
                    (Right now we have the option to give single teacher for single Batch-Subject 
                    <br />so please select single teacher from the bellow list)
                    <br />
                    <asp:GridView ID="gvSubject" runat="server" AutoGenerateColumns="false">
                        <Columns>
                            ...
                            <asp:TemplateField  HeaderText="Teacher">
                                <ItemTemplate>
                                    <%#String.Format("{0}", Eval("EmployeeName"))%>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
