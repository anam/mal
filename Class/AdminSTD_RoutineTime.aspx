<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site2Column.master"
    CodeFile="AdminSTD_RoutineTime.aspx.cs" Inherits="AdminSTD_RoutineTime" Title="Class RoutineTime" %>
        ...
        <div class="inner-form">
            <dl>
                ...
                <dd>
                    ...
                    <a   class="button button-blue"  target="_blank" id="a_RoutineDisplay" runat="server">Existing Routine of the Selected Teacher</a>
                    <br /><span  style="color:green;">Total 
                        <asp:Label ID="lblTotalNoOfClasses" runat="server" Text="0"></asp:Label> class hour per week(already have) = <asp:Label ID="lblHaveClassInHour" Font-Size="20px" runat="server" Text=""></asp:Label> Hour(s)</span>
            ...
            <div>
                <asp:GridView ID="gvListOfStudentsWhohaveClassesInOtherThanSelectClass" runat="server" AutoGenerateColumns="false"
                        CssClass="tabel_input">
                        <HeaderStyle CssClass="heading" />
                        <RowStyle CssClass="row" />
                        <AlternatingRowStyle CssClass="altrow" />
                        <Columns>
                            <asp:TemplateField HeaderText="Select">
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkSelect" runat="server" ToolTip='<%#Eval("ClassSubjectID")%>' ValidationGroup='<%#Eval("StudentID")%>'/>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="ID">
                                <ItemTemplate>
                                    <a target='_blank' href='EnrollmentHistory.aspx?StudentCode=<%#Eval("StudentCode")%>'><%#Eval("StudentCode")%></a> 
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Class">
                                <ItemTemplate>
                                    <a target='_blank' href='ClassSubjectAdd.aspx?ID=<%#Eval("ClassID")%>'><%#Eval("ClassName")%></a> 
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <asp:Button ID="btnDeleteClassSubject" runat="server"  class="button button-blue"
                    Text="Cencle From the related Class" onclick="btnDeleteClassSubject_Click" />
                <asp:Button ID="btnPassClassSubject" runat="server"  class="button button-blue"
                    Text="Make Passed In the related Class" onclick="btnPassClassSubject_Click" />
                    <asp:Button ID="btnDeleteFromSelectedClass" runat="server"  class="button button-blue"
                    Text="Cencle From the Selected Class" 
                    onclick="btnDeleteFromSelectedClass_Click" />
                    </div>
            </div>
            <div>
