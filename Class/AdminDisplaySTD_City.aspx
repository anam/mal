<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site2Column.master"
    CodeFile="AdminDisplaySTD_City.aspx.cs" Inherits="AdminDisplaySTD_City" Title="List Of Cities" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div class="content-box">
        ...
        <div class="inner-content">
            <asp:GridView ID="gvSTD_City" class="gridCss" runat="server" AutoGenerateColumns="false"
                CssClass="gridCss">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Delete">
                        <ItemTemplate>
                            ...
                            <asp:ImageButton runat="server" ID="lbDelete" OnClientClick="return confirm('Are You Sure, You Want To Delete?')"
                                CommandArgument='<%#Eval("CityID") %>' OnClick="lbDelete_Click" AlternateText="Delete"
