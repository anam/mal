<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site2Column.master"
    CodeFile="AdminDisplaySTD_ClassDay.aspx.cs" Inherits="AdminDisplaySTD_ClassDay"
    Title="List of Existing Class Day" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div class="content-box">
        <div class="header">
            <h3>
                List of Existing Class Day</h3>
        </div>
        <div class="inner-content">
            <asp:GridView ID="gvSTD_ClassDay" class="gridCss" runat="server" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Name Of Day">
                        <ItemTemplate>
                            <asp:Label ID="lblClassDayName" runat="server" Text='<%#Eval("ClassDayName") %>'>
 	                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
