...
public partial class Student_AttendantSheet : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["Date"] != null && Request.QueryString["StartTime"] != null && Request.QueryString["EndTime"] != null)
            {
                lblDate.Text = Request.QueryString["Date"];
                lblTimeIn.Text = Request.QueryString["StartTime"];
                lblTimeOut.Text = Request.QueryString["EndTime"];
            }
        }
    }
}