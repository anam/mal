        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                //{
                    ...
                    List<STD_Class> scs = STD_ClassManager.GetSTD_BasicInfoForStudentsAttentdantByStudentID(Request.QueryString["StudentID"]);
                    string table = "";
                    
                    foreach (STD_Class sc in scs)
                    {
                        classID = sc.ClassID;
                        ...
                        if (sc != null)
                        {
                            classDetails = @"<div style='width: 100%; float: left; margin-bottom: 30px'>
                <div style='width: 45%; float: left; line-height: 25px;'>
                    <span>Course: &nbsp;&nbsp;</span>";
                            classDetails += sc.CourseName;
classDetails +=@"&nbsp;&nbsp;&nbsp;&nbsp;
                    <br />
                    <span>Paper: &nbsp;&nbsp;</span>";
                    classDetails+=sc.SubjectName ;
classDetails +=@"<br />
                    <span>Lecturer: &nbsp;&nbsp;</span>";
                    classDetails+=sc.EmployeeName ;
                classDetails +=@"</div>
                <div style='width: 40%; float: right; margin-left: 20px; line-height: 25px;'>
                    
                    <span>Batch No: &nbsp;&nbsp;</span>";
                classDetails += sc.ClassName + " </div></div><div style='width: 100%; float: left; margin-bottom: 30px'>";
                        ...
                        if (classSubjectEmployeeStudent.Count == 0)
                        {
                            continue;
                        }
                        else
                        ...
                        table += "<table border='1'><tr><td>Name</td><td>ID</td>";
