<%@ Page Title="Employee Pay Role Salary" Language="C#" MasterPageFile="~/Site2Column.master"
    AutoEventWireup="true" CodeFile="AccountEmployPayRoleSalary.aspx.cs" Inherits="Accounting_AccountEmployPayRoleSalary" %>
            ...
            <asp:GridView ID="gvACC_EmployPayRoleSalary" runat="server" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Paid">
                        <ItemTemplate>
                            <asp:Button ID="lnkPaid" runat="server" Text="Pay" CommandArgument='<%#Eval("EmployPayRoleSalaryID") %>'
                                OnClick="lnkPaid_Click"></asp:Button>
                        </ItemTemplate>
                    </asp:TemplateField>
             ...
             <asp:GridView ID="gvSalaryHistory" runat="server" AutoGenerateColumns="false"  CssClass="tabel_input">
                <HeaderStyle CssClass="heading" />
                <RowStyle CssClass="row" />
                <AlternatingRowStyle CssClass="altrow" />
                <Columns>
                    
                    <asp:TemplateField HeaderText="Salary Of Month">
                        <ItemTemplate>
                            <asp:Label ID="lblName" runat="server" Text='<%#Eval("SalaryOfDate") %>'>
                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                   
                    <asp:TemplateField HeaderText="Total Salary" ItemStyle-CssClass="td_alignRight">
                        <ItemTemplate>
                            <asp:Label ID="lblSalaryOfDate" runat="server" Text='<%#Eval("SalaryAmount", "{0:#0.00}") %>'>
                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Paid Amount" ItemStyle-CssClass="td_alignRight">
                        <ItemTemplate>
                            <asp:Label ID="lblSalaryAmount" runat="server" Text='<%#Eval("PaidSalaryAmount", "{0:#0.00}") %>'>
                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Unpaid Salary" ItemStyle-CssClass="td_alignRight">
                        <ItemTemplate>
                            <asp:Label ID="lblPaidSalaryAmount" runat="server" Text='<%#Eval("UnpaidSalaryAmount", "{0:#0.00}") %>'>
                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
