<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site2Column.master"
    CodeFile="AdminACC_HeadUser.aspx.cs" Inherits="AdminACC_HeadUser" Title="Add/Update Account Head User" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div class="content-box">
        <div class="header">
            <h3>
              Add/Update Account Head User</h3>
        </div>
        <div class="inner-form">
            <!-- error and information messages -->
            <dl>
                <dt>
                    <asp:Label ID="lblHeadUserName" runat="server" Text="Head User Name: ">
    </asp:Label>
                </dt>
                <dd>
                    <asp:TextBox ID="txtHeadUserName" class="txt large-input" runat="server" Text="">
    </asp:TextBox>
                </dd>
                <dt>
