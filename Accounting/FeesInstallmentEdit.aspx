<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site2Column.master"
    CodeFile="FeesInstallmentEdit.aspx.cs" Inherits="AdminSTD_Fees" Title="Students fee" %>
        ...
        <div class="content-box" id="divSearchStudent" runat="server">
            ...
            <div class="content-box">
                ...
                <div class="inner-form">--%>
                    ...
                    <dl id="divFeesDetailsPerStudent" runat="server">
            ...
            <div class="content-box" id="divAddNewInstallationProcess" runat="server" >
                <div class="header">
                    <h3>
                        Add new fees (list)</h3>
                    <asp:HiddenField ID="hfFeesMasterIDEdit" runat="server" />
                </div>
                <div class="inner-form">
                <dl>
                       <dt>
                        ...
                        <dd> <asp:DropDownList ID="ddlCourseIDReceived" runat="server" >
                                </asp:DropDownList>
                                </dd>
                        <dt>
                        ...
                        <dd>
                            <asp:DropDownList ID="ddlAccountID" runat="server" AutoPostBack="true"  Enabled="false"
                                onselectedindexchanged="ddlAccountID_SelectedIndexChanged"></asp:DropDownList>
                        </dd>
                        <dt id="dtPerSubjectfee" runat="server" style="display:none;">
                            <asp:Label ID="Label4" runat="server" Text="Subject/Paper: "></asp:Label>
                        </dt>
                        <dd id="ddPerSubjectfee" runat="server" style="display:none;">
                       ...
                       <dt id="initialPaymentlbl" runat="server" style="display:none;">
                            <asp:Label ID="Label1" runat="server" Text="Admission Fee: "></asp:Label>
                        </dt>
                        <dd id="initialPaymentTxt" runat="server"  style="display:none;">
                            <asp:TextBox ID="txtInitialPaymentAmount" class="txt small-input" runat="server" Text="0"  AutoPostBack="true" ontextchanged="txtCalculateAmount_TextChanged"></asp:TextBox>
                        </dd>
                        <dt>
                            <asp:Label ID="lblNoOfInstallment" runat="server" Text="No of Installment: " ></asp:Label>
                        </dt>
                        <dd>
                            <asp:TextBox ID="txtNoOfInstallment"  Enabled="false" class="txt small-input" runat="server" Text="1" AutoPostBack="true" ontextchanged="txtCalculateAmount_TextChanged">
                            </asp:TextBox>
                        </dd>
                        ...
                        <dd>
                            <asp:TextBox ID="txtTotalAmount" class="txt small-input" runat="server" Text="0" AutoPostBack="true" Enabled="false"
                        ...
                        <dt>
                            <asp:Label ID="Label5" runat="server" Text="Paid Amount: ">
                        </asp:Label>
                        </dt>
                        <dd>
                            <asp:TextBox ID="txtPaidAmount" class="txt small-input" runat="server" Enabled="true">
                            </asp:TextBox>
                        </dd>
                        <dt>
                            <asp:Label ID="Label8" runat="server" Text="Extra Paid Amount: ">
                        </asp:Label>
                        </dt>
                        <dd>
                            <asp:TextBox ID="txtExtraPaidAmount" class="txt small-input" runat="server" 
                                Text="0" OnTextChanged="txtExtraPaidAmount_TextChanged" AutoPostBack="True"></asp:TextBox>
                        </dd>
                        <dt>
                            <asp:Label ID="Label6" runat="server" Text="Un paid Amount: ">
                            </asp:Label>
                        </dt>
                        <dd>
                            <asp:TextBox ID="txtUnpaidAmount" class="txt small-input" runat="server" Enabled="true">
                            </asp:TextBox>
                        ...
                        <dd>
                            <asp:TextBox ID="txtTotalAmountNeedToPay" class="txt small-input" runat="server" Text="" Enabled="false">
                            </asp:TextBox>
                        </dd>
                        <dt style="display:none;"></dt>
                        <dd style="display:none;">
                            <asp:Button ID="btnGridGenerator" class="button button-blue" Visible="false" runat="server" Text="Generate the List"
...
Date:  <asp:TextBox ID="txtSubmissionDateEdit" runat="server" Text=""></asp:TextBox>
                                    <ajaxToolkit:CalendarExtender Format="dd MMM yyyy" ID="ajCal" runat="server" TargetControlID="txtSubmissionDateEdit">
                    ...
                    <asp:Button ID="btnAddInstallment" class="button button-blue" runat="server" 
                                Text="Add Installment" onclick="btnAddInstallment_Click"
                               />
                    
                    <asp:GridView ID="gvFeesAdd" class="gridCss" runat="server" AutoGenerateColumns="false"  OnRowDataBound="gvFeesAdd_OnRowDataBound" 
                        ShowFooter="true"  CssClass="tabel_input">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Installment #">
                                <ItemTemplate>
                                    <asp:Label ID="lblInstallmentNo" Text='<%# Container.DataItemIndex + 1 -1 %>' runat="server"></asp:Label>
                                     <asp:CheckBox runat="server" ID="chkSelect" Visible="false"/>
                                    <asp:HiddenField runat="server" ID="hfIsPaid" Value='<%# Eval("IsPaid")  %>' />
                            ...
                            <asp:TemplateField HeaderText="Amount">
                                <ItemTemplate>
                                    Total:<asp:TextBox ID="txtAmount" runat="server" Text='<%# Eval("Amount")  %>' Enabled="false" CssClass="gridTextBox" AutoPostBack="true"
                                        OnTextChanged="txtAmount_OnTextChanged"></asp:TextBox>
                                
                                    <br />
                                    Paid:<asp:TextBox ID="txtPaidAmount" runat="server" Text='<%# Eval("Remarks")  %>'  CssClass="gridTextBox" AutoPostBack="true"
                                        OnTextChanged="txtAmount_OnTextChanged"></asp:TextBox>
                                    <br />
                                 
                                     Unpaid:<asp:TextBox ID="txtUnpaid" runat="server" Text='<%# Eval("UnpaidAmount")  %>' CssClass="gridTextBox" AutoPostBack="true"
                                        OnTextChanged="txtAmount_OnTextChanged"></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" ID="lbDeleteFees" CommandArgument='<%#Eval("FeesID") %>' Visible='<%# Eval("IsPaid")  %>' 
                        ...
                        <dt>&nbsp;</dt>
                        <dd>
                            <asp:Button ID="Button1" class="button button-blue" runat="server" Text="Update" OnClick="btnAdd_Click" />
            ...
            <div class="content-box" id="divReceivePayment" runat="server" visible="false" style="display:none;">
                <div class="header">
                    <h3>
                        Receive Fees</h3>
                </div>
           ...
           <div class="content-box" id="div1" runat="server" style="display:none;">
                <div class="header">
                    <h3>
                        Payment History</h3>
                </div>
