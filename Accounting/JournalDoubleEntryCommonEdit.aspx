<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site2Column.master"
    CodeFile="JournalDoubleEntryCommonEdit.aspx.cs" Inherits="AdminACC_Voucher" Title="Journal Double Entry" %>
        ...
        <ContentTemplate>
            <div class="content-box">
                ...
                <div class="inner-content">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Delete" Visible="false">
                                ...
                                AlternateText="Edit" OnClick="lbSelectJournal_Click" ImageUrl="~/App_Themes/CoffeyGreen/images/icon-pencil.png" />--%>
                                    <asp:ImageButton Visible="false" runat="server" ID="lbDelete" OnClientClick="return confirm('Are You Sure, You Want To Delete?')"
                    ...
                    <div>
                    <br />
                        <asp:DropDownList ID="ddlTablesNeedToDelete" runat="server">
                        </asp:DropDownList>
                        <asp:Button ID="btnDeleteJournal" runat="server" class="button button-blue" 
                             Text="Delete" onclick="btnDeleteJournal_Click" />
                            <br /><br />
                        Date: <asp:TextBox ID="txtDate" runat="server"  AutoPostBack="true"
                            ontextchanged="txtDate_TextChanged"></asp:TextBox>
                        <ajaxToolkit:CalendarExtender Format="dd MMM yyyy" ID="CalendarExtender2" runat="server" TargetControlID="txtDate">
                                            </ajaxToolkit:CalendarExtender>
                        <asp:HiddenField ID="hfDate" runat="server" />
                    Total Amount = 
                        <asp:Label ID="lblTotalAmount" runat="server" Text="0"></asp:Label>

                        <asp:Button ID="btnUpdateJournal" runat="server" Visible="false"  class="button button-blue" 
                            onclick="btnUpdateJournal_Click" Text="Update" />
