<%@ Page Title="" Language="C#" MasterPageFile="~/Site2Column.master" AutoEventWireup="true" CodeFile="AccountIncomeStatementView.aspx.cs" Inherits="Accounting_AccountIncomeStatementView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
     <div class="content-box">
        ...
        <div class="inner-form">
            ...
            <asp:Button ID="btnIncomeStatement" Text="View Report" runat="server" OnClick="btnIncomeStatement_OnClick" />
        </div>
        <div style="width: 98%; margin: 0px auto; min-height: 350px; overflow: scroll">
            <CR:CrystalReportViewer ID="crvIncomeStatement" runat="server" AutoDataBind="true" ToolPanelView="None"
