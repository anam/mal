<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site2Column.master"
    CodeFile="AdminLIB_BookIssue.aspx.cs" Inherits="AdminLIB_BookIssue" Title="Library Book Issue" %>
        ...
        <div class="inner-form">
            ...
            <dl>
                ...
                <%--class="txt large-input"--%>
                    ...
                    <ajaxToolkit:CalendarExtender  ID = "calIssueDate" runat = "server" Format = "dd MMM yyyy" TargetControlID = "txtIssueDate"></ajaxToolkit:CalendarExtender>
                ...
                <dd>
                    <asp:TextBox ID="txtReturnDate" runat="server" Text="" class="txt medium-input">
                     ...
                     <ajaxToolkit:CalendarExtender  ID = "calReturnDate" runat = "server" Format = "dd MMM yyyy" TargetControlID = "txtReturnDate"></ajaxToolkit:CalendarExtender>
