<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site2Column.master"
    CodeFile="AdminDisplayUSER_RoleWiseMenu.aspx.cs" Inherits="AdminDisplayUSER_RoleWiseMenu"
    Title="USER_RoleWiseMenu Insert/Update By Admin" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div class="content-box">
        ...
        <div class="inner-content">
            <asp:GridView ID="gvUSER_RoleWiseMenu" runat="server" AutoGenerateColumns="false"
