<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site2Column.master"
    CodeFile="Copy of FeesInstallment.aspx.cs" Inherits="AdminSTD_Fees" Title="Students fee" %>
                ...
                <div class="inner-form">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtStudentCodeSearch" class="txt medium-input" runat="server" Text=""></asp:TextBox>
                            </td>
                            <td></td>
                            <td></td>
                        </tr>
            ...
            <div class="content-box" id="divAddNewInstallationProcess" runat="server" visible="false">
                ...
                <dl>
                       ...
                       <dt id="initialPaymentlbl" runat="server">
                            <asp:Label ID="Label1" runat="server" Text="Innitial payment Amount: "></asp:Label>
                        </dt>
                        ...
                        <dd>
                            <asp:TextBox ID="txtTotalAmount" class="txt small-input" runat="server" Text="" AutoPostBack="true"
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr>
                                        <td >
                                                     ...
                                                     Total Unpaid Amount:</td><td><asp:Label ID="lblTotalUnPaidAmount" runat="server" Text='<%#Eval("ExtraField2") %>'></asp:Label>
                                                    </td></tr><tr><td>
