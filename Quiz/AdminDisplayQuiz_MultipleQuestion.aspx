<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site2Column.master"
    CodeFile="AdminDisplayQuiz_MultipleQuestion.aspx.cs" Inherits="AdminDisplayQuiz_MultipleQuestion"
    Title="List of Existing Multiple Choice Question" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="content-box">
        <div class="header">
            <h3>
                List of Existing Multiple Choice Question</h3>
        </div>
        <div class="inner-content">
           <dl>
            ...
            <asp:GridView ID="gvQuiz_MultipleQuestion" class="gridCss" runat="server" AutoGenerateColumns="false"
                CssClass="gridCss" OnRowDataBound="gvQuiz_MultipleQuestion_RowDataBound" HeaderStyle-CssClass="tableHead">
                <Columns>
                    <asp:TemplateField HeaderText="Multiple Question Name">
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblCourseID" runat="server" Visible="false" Text='<%#Eval("MultipleQuestionName") %>'></asp:Label>
                            <asp:Label ID="lblSubjectID" runat="server" Visible="false" Text='<%#Eval("SubjectID") %>'></asp:Label>
                            <asp:Label ID="lblChapterID" runat="server" Visible="false" Text='<%#Eval("ChapterID") %>'></asp:Label>
                            <h2 style="background-color: #E3E3E3; padding: 7px;">
                             ( :: <asp:Label runat="server" ID="lblSerial" Text='<%# ((GridViewRow) Container).RowIndex+1 %>'></asp:Label> :: )  <asp:Label ID="lblMultipleQuestionName" runat="server" Text='<%#Eval("MultipleQuestionName") %>'></asp:Label></h2>
                            </div>
                            <br />
                            <asp:GridView ID="gvMultipleQUestionsAnswer" runat="server" AutoGenerateColumns="false"
                                BorderStyle="Solid" BorderColor="Black" OnRowDataBound="gvMultipleQUestionsAnswer_RowDataBound"
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <b>
                                              ( <i><asp:Label runat="server" ID="lblSerial" Text='<%#     ((GridViewRow) Container).RowIndex+1  %>'></asp:Label> </i> ) 
                                                <asp:Label ID="lblAnswer" runat="server" Text='<%#Eval("QuestionTitle") %>'>
                                                </asp:Label></b>
                                            <hr />
                    ...
                    <asp:TemplateField HeaderText="Delete">
                        <ItemTemplate>
                            <asp:ImageButton runat="server" ID="lbSelect" CommandArgument='<%#Eval("MultipleQustionID") %>'
                                AlternateText="Edit" OnClick="lbSelect_Click" ImageUrl="~/App_Themes/CoffeyGreen/images/icon-pencil.png" />
                            <asp:ImageButton runat="server" ID="lbDelete" CommandArgument='<%#Eval("MultipleQustionID") %>' OnClientClick="return confirm('Are you sure to delete?');"
