<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site2Column.master"
    CodeFile="AdminDisplayQuiz_Chapter.aspx.cs" Inherits="AdminDisplayQuiz_Chapter"
    Title="List of Existing Quiz Chapter" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div class="content-box">
        <div class="header">
            <h3>
                List of Existing Quiz Chapter</h3>
        </div>
        <div class="inner-content">
            <asp:GridView ID="gvQuiz_Chapter" class="gridCss" runat="server" AutoGenerateColumns="false"
                OnRowDataBound="gvQuiz_Chapter_RowDataBound"  CssClass="tabel_input">
