<%@ Page Title="" Language="C#" MasterPageFile="~/Site2Column.master" AutoEventWireup="true"
    CodeFile="Copy of INV_MRR_Rpt.aspx.cs" Inherits="Inventory_INV_MRR_Rpt" %>
                                ...
                                <div class="inner-form">
                                    <table style="width: 100%; height: 31px;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="style26">
                                                <asp:LinkButton ID="LinkButton1" runat="server" Width="50px" OnClick="LinkButton1_Click"
                                    ...
                                    <asp:GridView ID="gvINV_MRRInfo" class="gridCss" runat="server" AutoGenerateColumns="false"
                                        CssClass="gridCss">
                                        <Columns>
                                            <asp:TemplateField HeaderText="MRR Info Name" HeaderStyle-Width="2%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMRRInfoID" runat="server" Text='<%#Eval("MRRInfoID") %>'>
 	 </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Campus Name" HeaderStyle-Width="3%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCampusID" runat="server" Text='<%#Eval("CampusID") %>'>
 	 </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="MRR Info Master Name" HeaderStyle-Width="8%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMRRInfoMasterID" runat="server" Text='<%#Eval("MRRInfoMasterID") %>'>
 	 </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="MRR Code" HeaderStyle-Width="7%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMRRCode" runat="server" Text='<%#Eval("MRRCode") %>'>
 	 </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Item Name" HeaderStyle-Width="4%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIteamID" runat="server" Text='<%#Eval("Description") %>'>
 	 </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Tag" HeaderStyle-Width="4%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTagID" runat="server" Text='<%#Eval("TagID") %>'>
 	 </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Quantity" HeaderStyle-Width="4%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblQuantity" runat="server" Text='<%#Eval("Quantity") %>'>
 	 </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="MRR Amount" HeaderStyle-Width="4%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMRRAmount" runat="server" Text='<%#Eval("MRRAmount") %>'>
 	 </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Sale Amount" HeaderStyle-Width="4%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSaleAmount" runat="server" Text='<%#Eval("SaleAmount") %>'>
 	 </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="MRR Date" HeaderStyle-Width="4%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMRRDate" runat="server" Text='<%#Eval("MRRDate") %>'>
 	 </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Store Name" HeaderStyle-Width="4%">
                                                <ItemTemplate>
