...
public partial class Inventory_NewPageByKhlid : System.Web.UI.Page
{
    ...
    protected void lnkBtnAdd_Click(object sender, EventArgs e)
    {
        ...
        string m_sirunit = "Unit";//this.txtUnit.Text.Trim();
        ...
        this.txtTag.Text = "";
        this.txtQty.Text = "";
        this.txtSalesRate.Text = "";
        this.txtMRRRate.Text = "";
    }
