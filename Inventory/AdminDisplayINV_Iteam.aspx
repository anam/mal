<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site2Column.master"
    CodeFile="AdminDisplayINV_Iteam.aspx.cs" Inherits="AdminDisplayINV_Iteam" Title="List of Existing Item" %>
...
<div class="content-box">
        ...
        <div class="inner-content">
            <dl>
                ...
                <dt>
                    <asp:Label ID="lblItemCode" runat="server" Text="Status : ">
                    </asp:Label>
                </dt>
                <dd>
                    ...
                    <asp:ListItem Value="0">Any</asp:ListItem>
                        ...
                        <asp:ListItem>Prize Given</asp:ListItem>
                        <asp:ListItem>Teachers Copy</asp:ListItem>
                        <asp:ListItem>In Library</asp:ListItem>
                        <asp:ListItem>Reject</asp:ListItem>
                    </asp:DropDownList>
                </dd>
                <dt>
                    <asp:Label ID="Label2" runat="server" Text="Place : ">
                    </asp:Label>
                </dt>
                <dd>
                    <asp:DropDownList ID="ddlPlace" runat="server" class="txt medium-input">
                    </asp:DropDownList>
                </dd>
                <dt>
    ...
    <div class="content-box">
        ...
        <div class="inner-content">
                ...
                <Columns>
                   ...
                   <%-- <asp:TemplateField HeaderText="Description">
                    ...
                    <asp:TemplateField HeaderText="Date">
                        <ItemTemplate>
                            <asp:Label ID="lblDate" runat="server" Text='<%#Eval("UpdatedDate","{0:dd MMM yyyy}") %>'>
 	                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Edit /Delete">
                        <ItemTemplate>
                            ...
                            <asp:ImageButton runat="server" ID="lbDelete" OnClientClick="return confirm('Are You Sure, You Want To Delete?')" Visible="false"
            ...
            <asp:DropDownList ID="ddlAction" runat="server" >
                ...
                <asp:ListItem Value="Issued">Prize Book</asp:ListItem>
                <asp:ListItem Value="Issued">Teacher copy</asp:ListItem>
                <asp:ListItem Value="In Store">Return to Store</asp:ListItem>
                <asp:ListItem Value="In Library">Return to Library</asp:ListItem>
                <asp:ListItem Value="In Store">Store --> Store</asp:ListItem>
                <asp:ListItem Value="In Library">Store --> Library</asp:ListItem>
                <asp:ListItem Value="In Library">Library --> Library</asp:ListItem>
                <asp:ListItem Value="In Store">Library --> Store</asp:ListItem>                
