<%@ Page Language="C#" AutoEventWireup="true"   MasterPageFile="~/Site2Column.master"  CodeFile="AdminINV_Issue.aspx.cs" Inherits="AdminINV_Issue" Title="INV_Issue Insert/Update By Admin" %>
 <asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
 </asp:Content>
 <asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
<div class="content-box">
<div class="header">
<h3>Add/Update Issue</h3>
</div>
...
<!-- error and information messages -->
    ...
    <dt>
     <asp:Label ID="lblIssueMasterID" runat="server" Text="Issue Master: ">
    </asp:Label>
     </dt>
    <dd>
    <asp:DropDownList ID="ddlIssueMasterID" runat="server">
     </asp:DropDownList>
     </dd>
    <dt>
