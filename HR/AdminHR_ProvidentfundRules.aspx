<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site2Column.master"
    CodeFile="AdminHR_ProvidentfundRules.aspx.cs" Inherits="AdminHR_ProvidentfundRules"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div class="content-box">
        ...
        <div class="inner-form">
            ...
            <dl>
                <dt>
                <asp:HiddenField ID = "hdnProvidentFundID" runat ="server" />
                ...
                <dt></dt>
                <dd>
                   <asp:CheckBox ID="radIsGrossPortion" class="txt large-input" runat="server" Text="Is Gross Portion" />
