<%@ Page Title="List of Existing Provident Fund Rules" Language="C#" MasterPageFile="~/Site2Column.master" AutoEventWireup="true"
    CodeFile="AdminDisplayHR_ProvidentfundRules.aspx.cs" Inherits="AdminDisplayHR_ProvidentfundRules" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="content-box">
        ...
        <div class="inner-content">
              <div>
                <asp:Button ID="btnAddProvidentFundRules" runat="server" class="button button-blue" Text="Add PF Rules"
                    OnClick="btnAddProvidentFundRules_OnClick" />
            </div>
            <asp:GridView ID="gvHR_ProvidentfundRules" class="gridCss" runat="server" AutoGenerateColumns="false"
                CssClass="tabel_input" OnRowDataBound ="gvHR_ProvidentfundRules_OnRowDataBound">
