...
public class SqlHR_SalaryAdjustmentListRulesProvider : DataAccessObject
{
    public SqlHR_SalaryAdjustmentListRulesProvider()
    {
    }
    ...
    public HR_SalaryAdjustmentListRules GetSalaryAdjustmentListRulesOnlyByEmployeeID(string employeeID)
    {
        HR_SalaryAdjustmentListRules SalaryAdjustmentListRuless = new HR_SalaryAdjustmentListRules();
        using (SqlConnection connection = new SqlConnection(this.ConnectionString))
        {
            SqlCommand command = new SqlCommand("GetHR_SalaryAdjustmentListRulesOnlyByEmployeeID", connection);
            command.CommandType = CommandType.StoredProcedure;
    ...
    public bool IsEmployeeExist(string employeeID)
    {
        using (SqlConnection connection = new SqlConnection(this.ConnectionString))
        {
            SqlCommand cmd = new SqlCommand("CheckEmployeeIDHR_SalaryAdjustmentListRules", connection);
    ...
    public bool DeleteHR_SalaryAdjustmentListRulesByEmployeeID(string employeeID)
    {
        using (SqlConnection connection = new SqlConnection(this.ConnectionString))
        {
            SqlCommand cmd = new SqlCommand("DeleteHR_SalaryAdjustmentListRulesByEmployeeID", connection);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@EmployeeID", SqlDbType.NVarChar).Value = employeeID;
            connection.Open();
