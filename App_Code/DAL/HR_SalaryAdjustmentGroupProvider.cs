...
public class SqlHR_SalaryAdjustmentGroupProvider:DataAccessObject
{
    ...
    public int InsertHR_SalaryAdjustmentGroup(HR_SalaryAdjustmentGroup hR_SalaryAdjustmentGroup)
    {
        using (SqlConnection connection = new SqlConnection(this.ConnectionString))
        {
            ...
            cmd.Parameters.Add("@AddedBy", SqlDbType.NVarChar).Value = hR_SalaryAdjustmentGroup.AddedBy;
            cmd.Parameters.Add("@AddedDate", SqlDbType.DateTime).Value = hR_SalaryAdjustmentGroup.AddedDate;
            connection.Open();
