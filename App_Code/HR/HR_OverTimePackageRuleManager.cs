...
public class HR_OverTimePackageRuleManager
{
    ...
    public static DataSet   GetAllHR_OverTimePackageRulesWithRelation()
    {
       DataSet hR_OverTimePackageRules = new DataSet();
        SqlHR_OverTimePackageRuleProvider sqlHR_OverTimePackageRuleProvider = new SqlHR_OverTimePackageRuleProvider();
        hR_OverTimePackageRules = sqlHR_OverTimePackageRuleProvider.GetAllHR_OverTimePackageRules();
    ...
    public static DataSet   GetHR_OverTimePackageByOverTimePackageID(int OverTimePackageID)
    {
        DataSet hR_OverTimePackageRules = new DataSet();
        SqlHR_OverTimePackageRuleProvider sqlHR_OverTimePackageRuleProvider = new SqlHR_OverTimePackageRuleProvider();
        hR_OverTimePackageRules = sqlHR_OverTimePackageRuleProvider.GetHR_OverTimePackageRuleByOverTimePackageID(OverTimePackageID);
        return hR_OverTimePackageRules;
    }


    public static HR_OverTimePackageRule GetHR_OverTimePackageRuleByOverTimeRuleID(int OverTimeRuleID)
    {
        HR_OverTimePackageRule hR_OverTimePackageRule = new HR_OverTimePackageRule();
        SqlHR_OverTimePackageRuleProvider sqlHR_OverTimePackageRuleProvider = new SqlHR_OverTimePackageRuleProvider();
        hR_OverTimePackageRule = sqlHR_OverTimePackageRuleProvider.GetHR_OverTimePackageRuleByOverTimeRuleID(OverTimeRuleID);
